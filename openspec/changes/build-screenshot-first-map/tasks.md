...
- [ ] 8.3 Publish the Afallon `A` compass mark as the Steam cover, browser favicons, and touch icon. Publish a `1200 × 630` Open Graph and Twitter card for the interactive map, and verify the production metadata and image responses.
