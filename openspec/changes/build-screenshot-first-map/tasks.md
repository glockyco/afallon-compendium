...
- [x] 8.8 Replace the persistent mobile category rail with a compact trigger and dismissible drawer. Keep the map toolbar, map status, and results within the viewport at phone widths.
