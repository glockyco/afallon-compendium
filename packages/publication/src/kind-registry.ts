...
export const PUBLIC_KIND_REGISTRY: readonly PublicKindEntry[] = Object.freeze([
  ...
  { kind: "gearSets", label: "Gear set", plural: "Gear sets", route: "gear-sets", icon: "gear-set", pages: true, searchable: true,
    columns: [column("memberCount", "Members", true), column("tierCount", "Tiers", true)],
    facets: [facet("memberCount", "Members"), facet("tierCount", "Tiers")] },
