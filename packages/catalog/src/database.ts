  ...
  try {
    db.exec(`
      ...
      CREATE TABLE IF NOT EXISTS conditions (
        ...
        scope TEXT CHECK(scope IS NULL OR scope IN ('equipment', 'use')),
      ...
      CREATE TABLE IF NOT EXISTS item_facts (
        ...
        action_abilities_json TEXT NOT NULL, use_lines_json TEXT NOT NULL, condition_ids_json TEXT NOT NULL, provenance_json TEXT NOT NULL
      ) STRICT;
      ...
      CREATE TABLE IF NOT EXISTS npc_facts (
        ...
        is_auctioneer INTEGER NOT NULL DEFAULT 0 CHECK(is_auctioneer IN (0, 1)), is_banker INTEGER NOT NULL DEFAULT 0 CHECK(is_banker IN (0, 1)), is_flight_master INTEGER NOT NULL DEFAULT 0 CHECK(is_flight_master IN (0, 1)), hunter_tamable INTEGER NOT NULL DEFAULT 0 CHECK(hunter_tamable IN (0, 1)), hunter_beast_role TEXT, equipment_appearance_selections TEXT, adventurer_json TEXT, flight_network_json TEXT,
      ...
      CREATE TABLE IF NOT EXISTS npc_phase_abilities (
        entity_key TEXT NOT NULL, phase_index INTEGER NOT NULL, ability_index INTEGER NOT NULL CHECK(ability_index >= 0), source_index INTEGER NOT NULL CHECK(source_index >= 0), ability_entity_key TEXT REFERENCES canonical_entities(entity_key), ability_label TEXT NOT NULL, rank_index INTEGER NOT NULL CHECK(rank_index >= 0), provenance_json TEXT NOT NULL,
      ...
      CREATE TABLE IF NOT EXISTS ability_facts (
        entity_key TEXT PRIMARY KEY NOT NULL REFERENCES canonical_entities(entity_key), ranks_json TEXT NOT NULL, provenance_json TEXT NOT NULL
      ) STRICT;
